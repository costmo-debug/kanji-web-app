...
const curatedMeaningOverrides = {
  上: ["位置が高いこと。", "前や表の方。", "身分や順番が先の方。"],
  下: ["位置が低いこと。", "後や裏の方。", "身分や順番が後の方。"],
  中: ["ものの内がわ。", "まん中。", "ある範囲のあいだ。"],
  大: ["形や量が大きいこと。", "大切であること。", "すぐれていること。"],
  小: ["形や量が小さいこと。", "年が幼いこと。", "少しであること。"],
  生: ["生きていること。", "生まれること。", "まだ手を加えていないこと。"],
  入: ["中へ入ること。", "仲間や組に加わること。", "お金などが入ってくること。"],
  出: ["中から外へ出ること。", "前に現れること。", "出発すること。"],
  見: ["目で見ること。", "調べること。", "考えたり判断したりすること。"],
  立: ["まっすぐ立つこと。", "物事を始めること。", "目立つこと。"],
  正: ["正しいこと。", "ちょうどその時やその場所。", "表がわ。"],
  早: ["時間が前であること。", "動きが速いこと。"],
  先: ["前の方。", "時間が前であること。", "相手や行き先。"],
  引: ["手前に近づける。ひっぱる。", "後ろへ下がる。しりぞく。", "線や印をかく。", "数や量をへらす。"],
  回: ["ぐるりと動くこと。", "順番がめぐってくること。", "何度か数える時に使うこと。"],
  会: ["人と人が会うこと。", "人が集まること。", "目的を持った集まり。"],
  合: ["一つになること。", "ぴったり合うこと。", "二つ以上を合わせること。"],
  行: ["目的の場所へ進むこと。", "物事をおこなうこと。", "文字のならび。"],
  来: ["こちらへ近づくこと。", "ある時がやって来ること。"],
  言: ["ことばで表すこと。", "ことばそのもの。"],
  食: ["食べること。", "食べ物。", "食事に関係すること。"],
  作: ["ものを作ること。", "考えて文章や作品を作ること。"],
  思: ["心で考えること。", "感じたり願ったりすること。"],
  知: ["わかること。", "覚えていること。", "知らせること。"],
  分: ["分けること。", "わかること。", "時間や量の一部。"],
  切: ["切ること。", "終わりになること。", "とても強くそう思うこと。"],
  長: ["長さがあること。", "時間が長いこと。", "人の上に立つ人。"],
  高: ["上までのびていること。", "ねだんや点数が大きいこと。", "すぐれていること。"],
  強: ["力があること。", "気持ちがしっかりしていること。", "程度が大きいこと。"],
  弱: ["力が少ないこと。", "苦手であること。", "程度が小さいこと。"],
  近: ["距離が短いこと。", "時間がすぐであること。", "関係が深いこと。"],
  遠: ["距離が長いこと。", "時間がずっと先であること。", "関係がうすいこと。"],
  広: ["ひろがっていること。", "範囲が大きいこと。"],
  細: ["細いこと。", "小さくくわしいこと。"],
  新: ["できたばかりであること。", "今までとちがって新しいこと。"],
  古: ["昔からあること。", "使って時間がたっていること。"],
  多: ["数や量がたくさんあること。"],
  少: ["数や量が少ないこと。", "少しであること。"],
  公: ["みんなに関係すること。", "自分だけのものではなく、おおやけのもの。"],
  画: ["線や色で表した絵。", "計画すること。", "漢字の線を数える単位。"],
  楽: ["心がうれしいこと。", "苦しくなくて楽なこと。", "音楽に関係すること。"],
  通: ["通ること。", "行き来すること。", "相手に伝わること。"],
  直: ["まっすぐであること。", "すぐであること。", "正しく直すこと。"],
  当: ["ちょうど合うこと。", "ぶつかること。", "受け持つこと。"],
  道: ["人や車が通るところ。", "物事のやり方。", "守るべき考え方。"],
  心: ["気持ち。", "考え。", "ものごとの中心。"],
  色: ["赤や青などの見え方。", "ものの様子や感じ。"]
};

Object.assign(curatedMeaningOverrides, {
  悪: ["よくないこと。", "正しくないこと。", "気分や状態がよくないこと。"],
  安: ["心配が少なく落ち着いていること。", "値段が低いこと。"],
  暗: ["光が少ないこと。", "気持ちが明るくないこと。", "よく分からないこと。"],
  開: ["閉じているものをあけること。", "始めること。", "広がること。"],
  感: ["心で感じること。", "外から受けた感じ。"],
  起: ["起きること。", "物事が始まること。"],
  急: ["とても早いこと。", "急いでいること。", "思いがけないこと。"],
  具: ["使うための道具。", "そなわっていること。"],
  決: ["決めること。", "はっきりさせること。"],
  死: ["命がなくなること。", "動かなくなること。"],
  使: ["道具や人を用いること。", "役目をさせること。"],
  始: ["物事が始まること。", "始めること。"],
  指: ["手の指。", "指で示すこと。", "目標を決めて向かうこと。"],
  主: ["中心になる人やもの。", "おもなこと。"],
  守: ["大切なものをまもること。", "決まりをまもること。"],
  取: ["手に取ること。", "自分のものにすること。", "取りのぞくこと。"],
  終: ["終わること。", "最後になること。"],
  集: ["集まること。", "集めること。"],
  重: ["重いこと。", "大切であること。", "同じことが重なること。"],
  消: ["消えること。", "消すこと。", "なくなること。"],
  深: ["底や奥までの距離が大きいこと。", "考えや気持ちが強いこと。"],
  進: ["前へ進むこと。", "物事がよくなること。"],
  送: ["人や物を届けること。", "見送ること。"],
  想: ["心に思いうかべること。", "考えや気持ち。"],
  速: ["動きがはやいこと。", "時間が短いこと。"],
  打: ["たたくこと。", "文字を入力すること。"],
  対: ["向かい合うこと。", "相手になること。", "比べること。"],
  待: ["来るまでそのままいること。", "楽しみにすること。"],
  代: ["かわりになること。", "時代。", "年齢の区切り。"],
  調: ["調べること。", "音や体の調子。", "整えること。"],
  着: ["服を身につけること。", "目的地に着くこと。"],
  発: ["出発すること。", "外へ出すこと。", "物事を始めること。"],
  反: ["反対すること。", "ひっくり返ること。"],
  負: ["まけること。", "背負うこと。", "責任を持つこと。"],
  放: ["外へ出すこと。", "自由にすること。", "そのままにすること。"],
  返: ["もとの場所へ戻すこと。", "相手に答えること。"],
  落: ["上から下へ落ちること。", "ぬけること。", "落ち着くこと。"],
  流: ["水などが流れること。", "広まること。", "時間が過ぎること。"],
  圧: ["強くおさえること。", "力をかけること。"],
  移: ["別の場所へうつること。", "変わっていくこと。"],
  易: ["やさしいこと。", "取りかえること。"],
  応: ["こたえること。", "状況に合わせること。"],
  過: ["通りすぎること。", "時間がすぎること。", "やりすぎること。"],
  解: ["分かるようにすること。", "問題をとくこと。", "ほどいてばらすこと。"],
  格: ["決まった形や位。", "人や物のよさ。"],
  確: ["たしかであること。", "はっきりしていること。"],
  慣: ["何度もしてなれること。"],
  禁: ["してはいけないこと。", "止めること。"],
  経: ["時間がたつこと。", "物事を通ること。", "経験すること。"],
  検: ["よく調べること。"],
  現: ["今あること。", "目の前にあらわれること。"],
  減: ["少なくなること。", "少なくすること。"],
  構: ["組み立てること。", "全体の作り。"],
  ...
  識: ["知って分かること。", "物事を見分ける力。"],
  質: ["ものの中身や性質。", "質問すること。"],
  修: ["学んで身につけること。", "直して整えること。"],
  準: ["よりどころになるもの。", "用意すること。"],
  設: ["作って置くこと。", "決まりや仕組みを作ること。"],
  増: ["数や量がふえること。", "ふやすこと。"],
  測: ["長さや量をはかること。"],
  断: ["切ること。", "はっきり決めること。", "ことわること。"],
  張: ["ぴんと広げること。", "強く主張すること。"],
  提: ["差し出すこと。", "考えを出すこと。"],
  適: ["ちょうど合っていること。"],
  得: ["手に入れること。", "分かること。"],
  ...
  迷: ["道や考えが分からなくなること。"],
  略: ["短く省くこと。", "大まかな計画。"],
  異: ["ふつうとちがうこと。", "別のものであること。"],
  遺: ["後に残すこと。", "忘れ物や残されたもの。"],
  延: ["長くのばすこと。", "予定より後にすること。"],
  映: ["光や影がうつること。", "映画などにうつすこと。"],
  拡: ["広げること。"],
  割: ["分けること。", "わること。", "役割。"],
  看: ["注意して見ること。", "世話をすること。"],
  危: ["あぶないこと。"],
  ...
  善: ["よいこと。", "正しいこと。"],
  創: ["新しく作り出すこと。"],
  操: ["手で動かすこと。", "心や体をうまく動かすこと。"],
  存: ["あること。", "生きていること。"],
  尊: ["大切にしてうやまうこと。"],
  退: ["後ろへ下がること。", "やめること。"],
  担: ["荷物や役目を受け持つこと。"],
  探: ["さがすこと。", "調べて見つけようとすること。"],
  著: ["はっきり目立つこと。", "本を書くこと。"],
  痛: ["体や心がいたむこと。"],
  展: ["広げること。", "物事が進んで広がること。"],
  難: ["むずかしいこと。", "困ったこと。"],
  認: ["たしかめて分かること。", "よいと受け入れること。"],
  納: ["おさめること。", "しまうこと。"],
  拝: ["うやまって頭を下げること。"],
  批: ["よい悪いを考えて言うこと。"],
  秘: ["人に知らせないこと。"],
...
function polishKanjiData() {
  kanjiData.forEach((item) => {
    const override = curatedMeaningOverrides[item.k];
    if (override) {
      item.meanings = override;
      item.meaning = override.join("");
    } else if (!Array.isArray(item.meanings) || !item.meanings.length) {
      item.meanings = splitMeaningText(item.meaning);
    }
  });
}
...
const okuriganaQuizzes = [
  ...
  },
  {
    ...
    prompt: "「おおきい」は、どう書く？",
    answer: "大きい",
    explanation: "「大きい」は「大」に「きい」を付けます。「大い」とは書きません。",
    options: ["大きい", "大い", "大"]
  },
  {
    label: "送り仮名も考えよう",
    ...
    prompt: "「ちいさい」は、どう書く？",
    answer: "小さい",
    explanation: "「小さい」は「小」に「さい」を付けます。「小い」ではありません。",
    options: ["小さい", "小い", "小"]
  },
  {
    label: "送り仮名も考えよう",
  ...
  },
  {
    ...
    prompt: "「とおい」は、どう書く？",
    answer: "遠い",
    explanation: "「遠い」は「遠」に「い」を付けます。「遠おい」と書かないようにします。",
    options: ["遠い", "遠おい", "遠"]
  },
  {
    label: "送り仮名も考えよう",
    ...
    prompt: "「かんがえる」は、どう書く？",
    answer: "考える",
    explanation: "「考える」は「考」に「える」を付けます。「考る」では送り仮名が足りません。",
    options: ["考える", "考る", "考え"]
  },
  {
    label: "送り仮名も考えよう",
  ...
  },
  {
    ...
    prompt: "「ふかい」は、どう書く？",
    answer: "深い",
    explanation: "「深い」は「深」に「い」を付けます。「深かい」とは書きません。",
    options: ["深い", "深かい", "深"]
  },
  {
    label: "送り仮名も考えよう",
    ...
    prompt: "「はじめる」は、どう書く？",
    answer: "始める",
    explanation: "「始める」は「始」に「める」を付けます。「始る」では送り仮名が足りません。",
    options: ["始める", "始る", "始"]
  },
  {
    label: "送り仮名も考えよう",
  ...
  },
  {
    ...
    prompt: "「つづける」は、どう書く？",
    answer: "続ける",
    explanation: "「続ける」は「続」に「ける」を付けます。「続る」ではありません。",
    options: ["続ける", "続る", "続"]
  },
  {
    label: "送り仮名も考えよう",
    ...
    prompt: "「くわえる」は、どう書く？",
    answer: "加える",
    explanation: "「加える」は「加」に「える」を付けます。「加る」では送り仮名が足りません。",
    options: ["加える", "加る", "加え"]
  },
  {
    label: "送り仮名も考えよう",
  ...
  },
  {
    ...
    prompt: "「まよう」は、どう書く？",
    answer: "迷う",
    explanation: "「迷う」は「迷」に「う」を付けます。「迷よう」と書かないようにします。",
    options: ["迷う", "迷よう", "迷"]
  },
  {
    label: "送り仮名も考えよう",
    ...
    prompt: "「かす」は、どう書く？",
    answer: "貸す",
    explanation: "「貸す」は「貸」に「す」を付けます。「貸」だけにしないようにします。",
    options: ["貸す", "貸", "貸し"]
  },
  {
    label: "送り仮名も考えよう",
  ...
  },
  {
    ...
    prompt: "「すてる」は、どう書く？",
    answer: "捨てる",
    explanation: "「捨てる」は「捨」に「てる」を付けます。「捨る」では送り仮名が足りません。",
    options: ["捨てる", "捨る", "捨"]
  },
  {
    label: "送り仮名も考えよう",
    ...
    prompt: "「くらす」は、どう書く？",
    answer: "暮らす",
    explanation: "「暮らす」は「暮」に「らす」を付けます。「暮す」と書くこともありますが、小学生の練習では「暮らす」を覚えます。",
    options: ["暮らす", "暮ら", "暮らせる"]
  }
];
